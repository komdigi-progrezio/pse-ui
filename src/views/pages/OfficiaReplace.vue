            ...
            <template v-slot:body-wrapper>
                <div class="modal-body">
                    <template v-if="modal.instansi.add">
                        <CRow>
                            <CCol sm="12">
                                ...
                                <message
                                    :messages="
                                        errorValidationsAddAgency.kelompok
                                    "
                                />
                            </CCol>
                            <CCol sm="12">
                                ...
                                <message
                                    :messages="
                                        errorValidationsAddAgency.kategori
                                    "
                                />
                            </CCol>
                            <CCol sm="12">
                                ...
                                />
                                <message
                                    :messages="errorValidationsAddAgency.name"
                                />
                            </CCol>
                            <CCol sm="12">
                                ...
                                ></textarea>
                                <message
                                    :messages="errorValidationsAddAgency.alamat"
                                />
                            </CCol>
                            <CCol sm="12">
                                ...
                                <select
                                    ...
                                    @change="getDistrict"
                                    @blur="
                                        errorValidationsAddAgency.propinsi = []
                                    "
                                >
                                    <option value="" selected="selected">
                                        Pilih Provinsi
                            ...
                            <CCol sm="12">
                                ...
                                <message
                                    :messages="errorValidationsAddAgency.kota"
                                />
                            </CCol>
                            <CCol sm="12">
                                ...
                                <input
                                    ...
                                    @blur="
                                        errorValidationsAddAgency.kode_pos = []
                                    "
                                />
                                <message
                                    :messages="
                            ...
                            <CCol sm="12">
                                ...
                                <input
                                    ...
                                    @blur="
                                        errorValidationsAddAgency.website = []
                                    "
                                />
                                <message
                                    :messages="
                    ...
                    <template v-else>
                        ...
                        <CPagination
                            :activePage.sync="
                                modal.instansi.pagination.current_page
                            "
...
export default {
    ...
    methods: {
            ...
            this.$http({
                ...
                .catch((error) => {
                    if (error.response.status === 422) {
                        ...
                        this.errorValidations.nip =
                            typeof error.response.data.errors.nip ===
                            'undefined'
                                ? []
                                : error.response.data.errors.nip;
                        this.errorValidations.jabatan =
                            typeof error.response.data.errors.jabatan ===
                            'undefined'
                                ? []
                                : error.response.data.errors.jabatan;
                        this.errorValidations.no_telepon =
                            typeof error.response.data.errors.no_telepon ===
                            'undefined'
                                ? []
                                : error.response.data.errors.no_telepon;
                        this.errorValidations.instansi_induk =
                            typeof error.response.data.errors.instansi_induk ===
                            'undefined'
                                ? []
                                : error.response.data.errors.instansi_induk;
                        this.errorValidations.dokumen =
                            typeof error.response.data.errors.dokumen ===
                            'undefined'
                                ? []
                                : error.response.data.errors.dokumen;
                        this.errorValidations.no_hp =
                            typeof error.response.data.errors.no_hp ===
                            'undefined'
                                ? []
                                : error.response.data.errors.no_hp;
                        this.errorValidations.status_register =
                            typeof error.response.data.errors
                                .status_register === 'undefined'
                                ? []
        ...
        getAgencyGroup() {
            axios
                .get(
                    `${process.env.VUE_APP_URL}/api/public/parconfig/agency/group`
                )
                .then((response) => {
        ...
        getAgency() {
            axios
                .get(
                    `${process.env.VUE_APP_URL}/api/public/parinstansi/filter`,
                    {
                        params: {
